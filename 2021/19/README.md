...
In the above example, scanners `2` (`1105,-1205,1229`) and `3` (`-92,-2380,-20`) are the largest Manhattan distance apart. In total, they are `1197 + 1175 + 1249 = `_`3621`_ units apart.

_What is the largest Manhattan distance between any two scanners?_

Your puzzle answer was `13148`.
