...
With these adapters, your device's built-in joltage adapter would be rated for `19 + 3 = `_`22`_ jolts, 3 higher than the highest-rated adapter.
...
Your puzzle answer was `386869246296064`.
