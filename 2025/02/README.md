...
Your puzzle answer was `18700015741`.
...
Your puzzle answer was `20077272987`.
...
* Part 1, Python: 152 bytes, ~1 s
* Part 2, Python (regular expressions): 153 bytes, ~1.5 s
* Part 2, Python (string maninpulation): 150 bytes, ~500 ms
