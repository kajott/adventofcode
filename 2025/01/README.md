...
Because the dial is a circle, turning the dial _left from `0_` on _click makes it point at `99`. Similarly, turning the dial _right from `99_` on _click makes it point at `0`.
