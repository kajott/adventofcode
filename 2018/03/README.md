...
The apparent 1Kx1K problem size turned out to not be a problem at all, as the patches are very small and the resulting list of occupied fields is quite sparse.
