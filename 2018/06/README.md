...
If there is an elegant solution that doesn't require brute-force calculation of the minimum distance for all points on the plane, I didn't find it. The bounding box of all input points was small enough (300x300-ish) to make this just barely feasible though; still, this is the most computationally expensive solution until now.
